...
VALUES ('User table', '03:00:00', 'Create table of users', 'TO_DO', 1),
       ('Order table', '02:00:00', 'Create table of orders', 'TO_DO', 1),
       ('Comment table', '01:30:00', 'Create table of comments', 'TO_DO', 1),
       ('UserEntity', '02:00:00', 'Create user entity', 'TO_DO', 2),
       ('OrderEntity', '02:30:00', 'Create order entity', 'TO_DO', 2),
       ('CommentEntity', '02:00:00', 'Create comment entity', 'TO_DO', 2),
       ('UserService', '04:00:00', 'Create user service', 'TO_DO', 3),
       ('OrderService', '04:00:00', 'Create order service', 'TO_DO', 3),
       ('CommentService', '04:00:00', 'Create comment service', 'TO_DO', 3),
       ('UserTest', '02:00:00', 'Create tests for user service', 'TO_DO', 4),
       ('OrderService', '02:00:00', 'Create tests for order service', 'TO_DO', 4),
       ('CommentService', '02:00:00', 'Create tests for comment service', 'TO_DO', 4),
       ('Main page', '04:00:00', 'Create main page', 'TO_DO', 5),
       ('Service pages', '10:00:00', 'Create service pages', 'TO_DO', 5),
       ('Auth service', '04:00:00', 'Create authentication service page', 'TO_DO', 5),
       ('Barbers service', '06:00:00', 'Create service for client', 'TO_DO', 5),
       ('User table', '03:00:00', 'Create table of users', 'TO_DO', 6),
       ('Order table', '02:00:00', 'Create table of orders', 'TO_DO', 6),
       ('Comment table', '01:30:00', 'Create table of comments', 'TO_DO', 6),
       ('UserEntity', '02:00:00', 'Create user entity', 'TO_DO', 7),
       ('OrderEntity', '02:30:00', 'Create order entity', 'TO_DO', 7),
       ('CommentEntity', '02:00:00', 'Create comment entity', 'TO_DO', 7),
       ('UserService', '04:00:00', 'Create user service', 'TO_DO', 8),
       ('OrderService', '04:00:00', 'Create order service', 'TO_DO', 8),
       ('CommentService', '04:00:00', 'Create comment service', 'TO_DO', 8),
       ('UserTest', '02:00:00', 'Create tests for user service', 'TO_DO', 9),
       ('OrderService', '02:00:00', 'Create tests for order service', 'TO_DO', 9),
       ('CommentService', '02:00:00', 'Create tests for comment service', 'TO_DO', 9),
       ('Main page', '04:00:00', 'Create main page', 'TO_DO', 10),
       ('Service pages', '10:00:00', 'Create service pages', 'TO_DO', 10),
       ('Auth service', '04:00:00', 'Create authentication service page', 'TO_DO', 10),
       ('Client service', '06:00:00', 'Create service for client', 'TO_DO', 10);
